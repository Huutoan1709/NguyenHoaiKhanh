        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg p-6">
            ...
            <div className="mt-4 text-sm text-gray-600">
              {stats.published > 0 && (
                <span>{Math.round((stats.published / pagination.total) * 100)}% tổng số</span>
              )}
            </div>
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <select
              ...
              className="h-12 px-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-primary-100 focus:border-primary-500 transition-all duration-200"
            >
